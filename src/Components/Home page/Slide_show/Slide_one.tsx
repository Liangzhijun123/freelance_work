        ...
        <div className="flex flex-col gap-[24px] justify-center px-[32px] py-[32px]">
          ...
          <div className="flex flex-row items-center">
            ...
            <p className="text-white text-left font-Sora font-semibold text-[24px]">
              <span className="font-Sora font-semibold text-[88px]">0</span>/mo
            </p>
          </div>
          <div>
          ...
          <div className="flex flex-col ">
            <div className="flex flex-row gap-[16px]  border-b border-[#ffffff15] w-[346px] h-[65px] p-4">
              <img
                ...
                alt="check"
              />
              <p className="text-[#CAC6DD] text-[18px] font-Inter">Character Creation - LIMIT 6</p>
            </div>
            <div className="flex flex-row gap-[16px]  border-b border-[#ffffff15] w-[346px] h-[65px] p-4">
              <img
                src="/image/checkyello.svg"
                ...
                alt="check"
              />
              <p className="text-[#CAC6DD] text-[18px] font-Inter">Custom Encounters - LIMIT 8</p>
            </div>
            <div className="flex flex-row gap-[16px]  border-b border-[#ffffff15] w-[346px] h-[65px] p-4">
              <img
                src="/image/checkyello.svg"
            ...
            <div className="flex flex-row gap-[16px]  border-b border-[#ffffff15] w-[346px] h-[65px] p-4">
              <img
                ...
                alt="check"
              />
              <p className="text-[#777980] text-[18px] font-Inter text-nowrap">Gain Early Access to Tools</p>
            </div>
