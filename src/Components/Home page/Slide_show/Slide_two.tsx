        ...
        <div className="flex flex-col gap-[24px] justify-center px-[32px] py-[32px]">
          ...
          <div className="flex flex-row items-center">
            ...
            <p className="text-white text-left font-Sora font-semibold text-[24px]">
              <span className="font-Sora font-semibold text-[88px]">2.99</span>
              /mo
            </p>
          </div>
          <div>
          ...
          <div className="flex flex-col ">
            <div className="flex flex-row gap-[16px]  border-b border-[#ffffff15] w-[346px] h-[65px] p-4">
              <img src="/image/checkyello.svg" className="" alt="check" />
              <p className="text-[#CAC6DD] text-[18px] font-Inter text-nowrap">
            ...
            <div className="flex flex-row gap-[16px]  border-b border-[#ffffff15] w-[346px] h-[65px] p-4">
              <img src="/image/checkyello.svg" className="" alt="check" />
              <p className="text-[#CAC6DD] text-[18px] font-Inter">
                Create Homebrew Content
              </p>
            </div>
            <div className="flex flex-row gap-[16px]  border-b border-[#ffffff15] w-[346px] h-[65px] p-4">
              <img src="/image/checkyello.svg" className="" alt="check" />
              <p className="text-[#777980] text-[18px] font-Inter text-nowrap">
            ...
            <div className="flex flex-row gap-[16px]  border-b border-[#ffffff15] w-[346px] h-[65px] p-4">
              <img src="/image/checkyello.svg" className="" alt="check" />
              <p className="text-[#777980] text-[18px] font-Inter text-nowrap">
                Gain Early Access to Player Tools
              </p>
            </div>
            <div className="flex flex-row gap-[16px]   w-[346px] h-[65px] p-4">
              <img src="/image/checkcancel.svg" className="" alt="check" />
              <p className="text-[#777980] text-[18px] font-Inter text-nowrap">
