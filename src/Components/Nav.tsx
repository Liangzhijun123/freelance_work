    ...
    <>
      ...
      <div className="hidden xl:flex md:flex bg-[#08050F] h-[96px] w-full items-center justify-evenly xl:px-[300px] md:px-[100px] p-[24px]  border-bottom-gradient">
        ...
        <div className="flex  gap-[20px]">
          <a
            href="#signin"
            className="text-[#F9C80E]  font-Inter text-[18px] border border-[#F9C80E] rounded-[8px] p-2 w-[128px] transition-colors duration-300 hover:bg-[#F9C80E] hover:text-black flex items-center justify-center"
          >
            Sign In
          </a>
          <a
